            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea x-model="jenisForm.deskripsi" name="deskripsi" rows="3"
                        class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-800 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-100"></textarea>
                </div>
                <div>
